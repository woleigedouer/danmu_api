...
如果没有找到合适的匹配，返回：
{
  ...
  static load(env = {}) {
    ...
    const envVarConfig = {
      ...
      // 系统配置
      'UI_THEME': { category: 'system', type: 'select', options: ['classic', 'ocean', 'forest', 'graphite', 'berry', 'monochrome', 'sunset', 'aurora', 'mist', 'terminal', 'lavender'], description: '管理界面主题' },
    ...
    return {
      ...
      uiTheme: this.get('UI_THEME', 'classic', 'string').toLowerCase(), // 管理界面主题
