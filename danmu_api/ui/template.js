    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="section" id="env-section">
                <div class="env-section-header" style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 24px; flex-wrap: wrap; gap: 16px;">
                    <div>
                ...
                <div class="env-toolbar-actions" style="display: flex; gap: 12px; flex-wrap: wrap;">
